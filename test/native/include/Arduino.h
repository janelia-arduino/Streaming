...
inline size_t strlen_P(const char *str) { return strlen(str); }
...
public:
  ...
  size_t print(const String &value) { return print(value.c_str()); }
...
private:
  template <typename T> size_t printSigned(T value, int base) {
    if (base == 0) {
